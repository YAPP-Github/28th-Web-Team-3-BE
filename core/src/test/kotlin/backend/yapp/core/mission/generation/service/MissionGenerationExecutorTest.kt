...
class MissionGenerationExecutorTest {
    ...
    fun `retrieved and verified knowledge crosses the executor boundary into generation`() {
        ...
        val retrieval = MissionKnowledgeRetrievalResult(knowledge, 1, MissionKnowledgeSelectionPolicy.ALL)
        ...
        `when`(fixture.generator.generate(MissionAlternativeGenerationRequest(fixture.work.item, knowledge)))
            .thenReturn(fixture.generated)

        MissionGenerationExecutor(fixture.workService, fixture.retriever, fixture.verifier, fixture.generator)
            .execute(fixture.work.jobId)

        verify(fixture.generator).generate(MissionAlternativeGenerationRequest(fixture.work.item, knowledge))
    ...
    fun `retrieval failure uses empty knowledge and still completes`() {
        ...
        `when`(fixture.generator.generate(MissionAlternativeGenerationRequest(fixture.work.item, emptyList())))
            .thenReturn(fixture.generated)
    ...
    fun `generation failure releases the claimed job for retry`() {
        ...
        `when`(fixture.retriever.retrieve(fixture.request)).thenReturn(
            MissionKnowledgeRetrievalResult(emptyList(), 0, MissionKnowledgeSelectionPolicy.EMPTY),
        )
        `when`(fixture.verifier.verify(emptyList())).thenReturn(emptyList())
        `when`(fixture.generator.generate(MissionAlternativeGenerationRequest(fixture.work.item, emptyList())))
    ...
    private fun fixture(): Fixture {
        ...
        val request = MissionKnowledgeRetrievalRequest(work.jobId, work.item, query, LocalDate.now(clock))
        ...
        return Fixture(workService, retriever, verifier, generator, work, request, generated)
    }
