...
class SpringAiMissionAlternativeGenerator(
    ...
    companion object {
        private const val SYSTEM_INSTRUCTION = """
            당신은 소비 절약 대안 미션 문구 생성기입니다. 제공된 지식이 있으면 그 범위 안에서 구체적인 미션을 생성하세요. 
            제공된 지식이 없으면 항목에 맞는 절약 미션을 생성하세요. 
            절약 미션을 생성할시 외부 데이터를 수집하세요 Google, youtbe, tistory 절약 미션 생성시 사용한 외부 데이터 Url도 함께 제공하세요.
             ...
             {count}를 금액, 기간, 배수, 종류·개수, 단계, 분량 단위와 결합하지 마세요. 절약 금액, 우선순위 라벨, 출처, 링크를 만들지 마세요.
        """
